...
Gemini models can accept various media types (images, video, audio, PDF) as input.
...
GENKIT provides support for Gemini's text-to-speech capabilities.
...
The following features are not yet supported in the Dart SDK:
- Embeddings
